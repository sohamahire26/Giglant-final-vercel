...
const faqItems = [
  ...
  { question: "How can I provide feedback or report a bug?", answer: "Logged-in users can use the 'Contact' button in the navigation bar to submit feedback, report bugs, or contact support directly through our in-app messaging system." },
];
